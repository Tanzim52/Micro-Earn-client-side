          ...
          >
            {!user ? (
              <>
                ...
                <li>
                  <button onClick={() => scrollToSection("Get Started")}>Get Started</button>
                </li>
              </>
            ) : (
              <>
                ...
                <li>
                  <button onClick={() => scrollToSection("Testimonial")}>Testimonial</button>
                </li>
                <li>
        ...
        {user ? (
          <>
            ...
            <div className="dropdown dropdown-end">
              ...
              <ul tabIndex={0} className="menu menu-sm dropdown-content bg-[#3D405B] text-white rounded-box shadow-lg mt-3 w-52 p-2">
                <li>
                  <Link to={getDashboardLink()} className="justify-between">
                    Dashboard
                  </Link>
                </li>
                <li>
          ...
          <div className="hidden md:flex space-x-2">
            ...
            <Link target="_blank" to="https://github.com/Tanzim52/Micro-Earn-client-side" className="btn bg-secondary text-white">
              Join as Developer
            </Link>
          </div>
        )}
