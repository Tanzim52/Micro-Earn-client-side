    ...
    return (
        <div className='max-w-screen-lg shadow-xl  text-white rounded-xl p-10 bg-primary pt-20 min-h-[350px] gap-6 flex md:flex-row flex-col my-20 mx-auto'>
            <div className='flex-1 space-y-8'>
                ...
                <p>Take few minutes to complete micro jobs anytime and anywere with no prior experience. Be stess-free and choose simple jobs in varius categories and start earning now with μ-Earn!</p>
            </div>
